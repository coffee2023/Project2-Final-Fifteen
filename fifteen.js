(function() {
    ...
    var space_Row = 3;
    var space_Column = 3;
    var size = 100; // size of each tile
	var totalSeconds = 0;
	var is_First = true;
	var my_Timer;
	var hour = 0;
    ...
    //when page loads create the following
	...
	function add_bg_events(num_pic) {
		...
		for (var i = 0; i <= num_pic-1; i++) {	
			var img_file = "pic" + i;
			var img_file_F = img_file + ".jfif";
    ...
    function reset_score(){
        ...
        audio.currentTime = 0;
        audio.volume = 0.3; // Reduce volume. May need to be adjusted if different track used. 
        audio.play();
    }

    function set_MoveText(){
        // Sets up text that contains win count and counter. 
        let text = "Moves Made: " + moves.toString();
